            ...
            <div className="card mx-auto w-full max-w-5xl shadow-xl">
                ...
                <div className=''>
                        <div className="hero min-h-full rounded-l-xl bg-base-200">
                            <div className="hero-content py-12">
                                <div className="max-w-md">
                                    <h1 className="mb-10 text-center font-bold text-lg"> ورود به پنل اتوبوس دارها</h1>
                        ...
                        <form onSubmit={(e) => submitForm(e)}>
                            ...
                            <div className='text-right text-primary'><Link to="/drivers/forgot-password"><span className="text-sm  inline-block  hover:text-primary hover:underline hover:cursor-pointer transition duration-200">پسورد را فراموش کردید؟</span></Link>
                            </div>
                            ...
                            حساب ندارید؟
                                <Link to="/drivers/register"><span className="inline-block hover:text-primary hover:underline hover:cursor-pointer transition duration-200 mr-2">  ثبت نام </span></Link>

    ...
    return (
        <div className="min-h-screen bg-base-200 flex items-center">
            <div className="card mx-auto w-full max-w-5xl shadow-xl">
                <div className="grid mt-4 md:grid-cols-2 grid-cols-1  bg-base-100 rounded-xl">
                    <div className=''>
                        <div className="hero min-h-full rounded-l-xl bg-base-200">
                            <div className="hero-content py-12">
                                <div className="max-w-md">
                                    <h1 className="mb-10 text-center font-bold text-lg">ثبت نام در پنل اتوبوس دارها</h1>
                    ...
                    <div className='py-10 px-10'>
                        ...
                        <form onSubmit={(e) => submitForm(e)}>
                            ...
                            <div className="">
                                ...
                                {/* <InputText defaultValue={registerObj.name} updateType="name" containerStyle="mt-4" labelTitle="نام کاربری" updateFormValue={updateFormValue} /> */}
                                <InputText defaultValue={registerObj.emailId} updateType="emailId" containerStyle="mt-4" labelTitle="ایمیل" updateFormValue={updateFormValue} />
                            ...
                            <div className='text-center mt-4'>حساب دارید؟<Link to="/drivers/login"><span className="  inline-block  hover:text-primary hover:underline hover:cursor-pointer transition duration-200"> ورود</span></Link></div>
                        </form>
                    </div>
                </div>
            </div>

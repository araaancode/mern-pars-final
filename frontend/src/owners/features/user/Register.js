                ...
                <div className="grid mt-4 md:grid-cols-2 grid-cols-1  bg-base-100 rounded-xl">
                        ...
                        <div className="hero min-h-full rounded-l-xl bg-base-200">
                            <div className="hero-content py-12">
                                <div className="max-w-md">
                                    <h1 className="mb-6 text-center font-bold text-lg">ثبت نام در پنل ملک دارها</h1>
                    ...
                    <div className='py-10 px-10'>
                        ...
                        <form onSubmit={(e) => submitForm(e)}>
                            ...
                            <div className='text-center mt-4'>حساب دارید؟<Link to="/owners/login"><span className="  inline-block  hover:text-primary hover:underline hover:cursor-pointer transition duration-200"> ورود</span></Link></div>
                        </form>
                    </div>
                </div>
            </div>

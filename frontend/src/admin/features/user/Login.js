            ...
            <div className="card mx-auto w-full max-w-5xl shadow-xl">
                ...
                <div className=''>
                        ...
                        <form onSubmit={(e) => submitForm(e)}>
                            ...
                            <div className='text-right text-primary'><Link to="/admins/forgot-password"><span className="text-sm  inline-block  hover:text-primary hover:underline hover:cursor-pointer transition duration-200">پسورد را فراموش کردید؟</span></Link>
                            </div>
                            ...
                            حساب ندارید؟
                                <Link to="/admins/register"><span className="inline-block hover:text-primary hover:underline hover:cursor-pointer transition duration-200 mr-2">  ثبت نام </span></Link>

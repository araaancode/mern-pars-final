                ...
                <div className="grid  md:grid-cols-2 grid-cols-1  bg-base-100 rounded-xl">
                    <div className=''>
                        <div className="hero min-h-full rounded-l-xl bg-base-200">
                            <div className="hero-content py-12">
                                <div className="max-w-md">
                                    <h1 className="mb-6 text-center font-bold text-lg"> ورود به پنل غذادارها</h1>
                        ...
                        <form onSubmit={(e) => submitForm(e)}>
                            ...
                            <div className='text-right text-primary'><Link to="/cooks/forgot-password"><span className="text-sm  inline-block  hover:text-primary hover:underline hover:cursor-pointer transition duration-200">پسورد را فراموش کردید؟</span></Link>
                            </div>
                            ...
                            <div className='text-center mt-4'>
                                حساب ندارید؟
                                <Link to="/cooks/register"><span className="inline-block hover:text-primary hover:underline hover:cursor-pointer transition duration-200 mr-2">  ثبت نام </span></Link>
